1. Spring provides special annotations called Stereotype annotations which will help tp create the spring beans automatically in the application context.
